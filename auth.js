...
function save_Draft(auth){
    Mail = require('./createMail.js');
    // receiversMail@gmail.com : mail id of the receiver
    var obj = new Mail(auth, "receiversMail@gmail.com", 'Subject', 'Body', 'draft');
    obj.makeBody();
}

function send_Mail(auth){
    Mail = require('./createMail.js');
    // receiversMail@gmail.com : mail id of the receiver
    var obj = new Mail(auth, "receiversMail@gmail.com", 'Subject', 'Body', 'mail');
    obj.makeBody();
}
...
module.exports.saveDraft =  function(){
  ...
  fs.readFile('./client_secret.json', (err, content) => {
      ...
      */
      authorize(JSON.parse(content), save_Draft);
  });
}
...
module.exports.sendMail =  function(){
  ...
  fs.readFile('./client_secret.json', (err, content) => {
      ...
      /*
        authorize function will try authorize using the credentials above and get a callback 'getAuth'
      */
      authorize(JSON.parse(content), send_Mail);
  });
}
