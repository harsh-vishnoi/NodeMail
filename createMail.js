...
/*
		class : CreateMail
		function {
				makeBody() : create mail functionality
				sendMail() : send mail functionality
				saveDraft() : save draft functionality
				deleteDraft() : delete draft functionality
				listAllDrafts() : list all draft functionality
		}
*/
class CreateMail{

	constructor(auth, to, sub, body, task){
    this.me = 'YourMail@gmail.com';
    this.task = task;
    this.auth = auth;
    this.to = to;
    this.sub = sub;
